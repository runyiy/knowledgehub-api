...
from app.crud.post import create_post, get_post, update_post, delete_post, get_visible_posts
...
def read_posts(
    ...
    items, total = get_visible_posts(db, current_user = current_user, skip=skip, limit=limit, mine=mine, is_public=is_public)
